...
@Repository
public class SpFullViewEventRepository {

  @Autowired
  private EntityManager em;
  
  public Stream<SpFullViewEvents> getFullViewEvents(LocalDate beginDate, LocalDate endDate) {
    List<Object[]> results = em.createNativeQuery("call sp_non_etas_events(?1, ?2)")
