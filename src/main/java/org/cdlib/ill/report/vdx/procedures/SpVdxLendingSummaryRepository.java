...
@Repository
public class SpVdxLendingSummaryRepository {
     ...
     */
    public Stream<SpVdxLendingSummary> getLendingSummary(String campus, LocalDate beginDate, LocalDate endDate) throws IllegalArgumentException {
        ...
        return results.stream().map((Object[] values) -> {
            ...
            return new SpVdxLendingSummary(
