...
@Repository
public class VdxLendingRepository extends VdxBaseRepository {
     ...
     */
    public Stream<VdxLendingSummary> getLendingSummary(String campus, LocalDate beginDate, LocalDate endDate) throws IllegalArgumentException {
