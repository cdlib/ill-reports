...
@Repository
public class SpVdxLendingPatronRepository {

  @Autowired
  private EntityManager em;

  public Stream<SpVdxLendingPatron> getLendingPatron(String campus, LocalDate beginDate, LocalDate endDate) {
    List<Object[]> results = em.createNativeQuery("call sp_vdx_lending_patron(?1, ?2, ?3)")
