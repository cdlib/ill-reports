...
public class VdxBorrowingRepository extends VdxBaseRepository {
    ...
    public Stream<VdxBorrowingUC> getBorrowingUC(String campus, LocalDate beginDate, LocalDate endDate) {
        List<Object[]> results = em.createNativeQuery("call sp_vdx_borrowing_uc(?1, ?2, ?3)")
                .setParameter(1, campus)
                .setParameter(2, beginDate)
                .setParameter(3, endDate)
                .getResultList();
