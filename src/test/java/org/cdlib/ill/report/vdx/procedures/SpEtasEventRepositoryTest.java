...
public class SpEtasEventRepositoryTest {
  ...
  public void testGetEtasEvents() {
    ...
    Assert.assertEquals(Sets.newSet(new SpEtasEvents("UCB", Long.valueOf(1), Long.valueOf(2), Long.valueOf(3), Long.valueOf(4), Long.valueOf(5), Long.valueOf(6)),
        new SpEtasEvents("UCLA", Long.valueOf(1), Long.valueOf(2), Long.valueOf(3), Long.valueOf(4), Long.valueOf(5), Long.valueOf(6)),
        new SpEtasEvents("UCB", Long.valueOf(4), Long.valueOf(8), Long.valueOf(9), Long.valueOf(7), Long.valueOf(2), Long.valueOf(4))),
